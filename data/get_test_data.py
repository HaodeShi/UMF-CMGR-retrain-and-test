...
class getDeformableImages:
    ...
    def __init__(self):
        ...
        self.elastic = ElasticTransform(kernel_size=101, sigma=16) # 101   16
        self.affine  = AffineTransform(translate=0.01) # 0.01 
...
def hyper_args():
    ...
    # dataset
    parser.add_argument('--ir', default='dataset/Roadscene/ir_256', type=pathlib.Path)
    parser.add_argument('--vi', default='dataset/Roadscene/vi_256', type=pathlib.Path)
    parser.add_argument('--dst', default='dataset/Roadscene/Bian_xing', help='fuse image save folder', type=pathlib.Path)

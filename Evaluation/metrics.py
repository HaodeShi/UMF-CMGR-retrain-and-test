...
if __name__ == '__main__':
    ...
    # dataset/Roadscene/Bian_xing/ir_warp   未配准   # Average MSE=0.010862, NCC=0.88515, LNCC=0.46757

    # dataset/Roadscene/Peizhun/ir_reg      配准    # Average MSE=0.0047011, NCC=0.94955, LNCC=0.59264

    root_in = 'dataset/Roadscene/Peizhun/ir_reg' 
    root_gt = 'dataset/Roadscene/ir_256'  
